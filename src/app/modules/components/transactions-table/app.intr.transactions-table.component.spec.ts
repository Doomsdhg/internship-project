...
import { Column, Row, TransactionsTableComponent } from './app.intr.transactions-table.component';
import {
  TranslateModule,
  TranslateLoader,
...
import { Transaction } from '../../interfaces/app.intr.transactions.interface';
