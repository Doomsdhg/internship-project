export class TranslationsEndpoints {
    ...
    static readonly DISPLAYED_COLUMNS = {
        ...
        DISPLAYED_COLUMNS_AMOUNT: 'displayedColumns.amount',
        DISPLAYED_COLUMNS_COMMISSION_AMOUNT: 'displayedColumns.commissionAmount',
        DISPLAYED_COLUMNS_PROVIDER: 'displayedColumns.provider',
        DISPLAYED_COLUMNS_ACTIONS: 'displayedColumns.actions',
        DISPLAYED_COLUMNS_STATUS: 'displayedColumns.status'
    };
}
