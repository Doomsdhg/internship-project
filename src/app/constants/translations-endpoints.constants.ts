export class TranslationsEndpoints {
    ...
    static readonly SNACKBAR_DISPLAYED_COLUMNS_COMMISSION_AMOUNT = 'displayedColumns.commissionAmount';
    ...
    static readonly SNACKBAR_DISPLAYED_COLUMNS_STATUS = 'displayedColumns.status';
