export class Columns {
    ...
    static readonly ID_COMISSION_AMOUNT = 'comissionAmount';
    static readonly ID_USERNAME = 'username';
    ...
    static readonly NAME_COMISSION_AMOUNT = 'Comission amount';
    static readonly NAME_USERNAME = 'Username';
